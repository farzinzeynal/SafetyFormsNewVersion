...
public class VehicleSafetyFormAdapter extends  RecyclerView.Adapter<VehicleSafetyFormAdapter.CostomViewHolder>
{
    ...
    public VehicleSafetyFormAdapter(Context mcontext, List<String> myList)
    {
